...
namespace AtomicSeller.Helpers.Razor.HtmlExtensions
{
    public static class PanelWrapExtension
    {
        ...
        public static IDisposable PanelWrap(this IHtmlHelper htmlHelper, string panelTitle, ContentType type = ContentType.Raw, string classes = "", bool primary=true, string classeTitle = "")
        {
